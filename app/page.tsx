    ...
    <div className="flex flex-col min-h-screen">
      <header className="py-4 px-6 border-b">
        <div className="container mx-auto flex items-center gap-2">
          ...
          <h1 className="text-2xl font-bold font-headline">Leaf Disease Identifier</h1>
        </div>
      </header>
      ...
      <footer className="py-4 px-6 border-t mt-auto">
        <div className="container mx-auto text-center text-sm text-muted-foreground">
          <p>Leaf Disease Identifier is for educational purposes only. For critical applications, please consult a professional.</p>
        </div>
      </footer>
    </div>
  );
